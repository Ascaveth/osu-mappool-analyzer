...
- **Mod category semantics** (what "HD" *means* to an analyzer) — analyzers interpret category names as plain labels; no analyzer should hardcode "HD" as a special case, per Architecture Principle 4.
